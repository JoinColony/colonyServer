...
interface IMetaColonyInterface extends Interface {
  functions: {
    ...
    getTaskPayout: TypedFunctionDescription<{
      encode([_id, _role, _token]: [BigNumberish, BigNumberish, string]): string
    }>
    ...
    getExpenditureSlotPayout: TypedFunctionDescription<{
      encode([_id, _slot, _token]: [BigNumberish, BigNumberish, string]): string
    }>
...
export class IMetaColony extends Contract {
  ...
  addGlobalSkill(overrides?: TransactionOverrides): Promise<ContractTransaction>
